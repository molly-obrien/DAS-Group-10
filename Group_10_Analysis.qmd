...
#| echo: false
#| eval: true
#| fig-cap: Scatterplot of Proportion of susceptible children to measles over the period 1998 to 2012
#| label: fig-1
...
boxplot(dataset$prop~dataset$Year)
...
-   Before 2004 we can see there is no significant trend between year and the proportion of children susceptible, wheras after this we can see a decreasing linear trend between year and proportion of children susceptible to measles.
